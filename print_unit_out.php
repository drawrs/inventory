		...
		$content = "<table style='padding-bottom: 10px; width: 240mm;'>
					...
					<table cellpadding='0' cellspacing='0' style='width: 240mm;'>
						<tr>
							...
							<td style='padding: 2px 0px 2px 0px; font-size: 9pt; width: 28mm;'>Nomor DO</td>
							<td style='padding: 2px 0px 2px 0px; font-size: 9pt; width: 3mm;'>:</td>
							<td style='padding: 2px 0px 2px 0px; font-size: 9pt; width: 35mm;'>$dataMain[doNo]</td>
						...
						while ($dtDoDetail = mysqli_fetch_array($sqlDoDetail))
						{
							...
							$content .= "
									<tr valign='top'>
										...
										<td style='padding: 2px 0px 2px 0px; font-size: 9pt; text-align: center;'>$dtDoDetail[deliveredQty]</td>
					...
					<table cellpadding='0' cellspacing='0' style='width: 230mm;'>
						<tr valign='top'>
							...
							<td style='padding: 5px 0px 5px 0px; font-size: 9pt; text-align: right; width: 100mm;'>
								<table>
									<tr>
										<td style='width: 60mm; text-align: right;'>Jumlah Harga Jual</td>
