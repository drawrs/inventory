		...
		$content = "<table style='padding-bottom: 10px; width: 240mm;'>
					...
					<table cellpadding='0' cellspacing='0' style='width: 240mm; border-bottom: 1px solid #000;'>
						<tr>
							...
							<th style='width: 20mm; padding: 2px 0px 2px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>SATUAN</th>";
						...
						if ($categoryID != '')
						{
							$queryStock = "SELECT * FROM as_products WHERE categoryID = '$categoryID' ORDER BY productCode ASC";
						}
						else
						{
						...
						while ($dataStock = mysqli_fetch_array($sqlStock))
						{
							...
							$content .= "
									<tr valign='top'>
										...
										<td style='padding: 2px 30px 2px 0px; font-size: 9pt;'>$unit</td>";
