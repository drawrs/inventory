										...
										<td>
											...
											<table cellpadding="3" cellspacing="3">
												...
												<tr>
													...
													<td style="border-right: 1px solid #000000; background-color: #FFFFFF;"><input type="text" id="staffName" name="staffName" class="form-control" placeholder="Nama Staff" style="width: 270px;" required></td>
													<td></td>
													<td>Jabatan</td>
													<td>:</td>
												...
												<tr>
													...
													<td style="background-color: #FFFFFF;">:</td>
													<td style="border-right: 1px solid #000000; background-color: #FFFFFF;"><input type="text" id="phone" name="phone" class="form-control" placeholder="Nomor Telepon Staff" style="width: 270px;"></td>
													<td></td>
													<td colspan="3"></td>
												</tr>
												<tr>
