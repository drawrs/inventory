	...
	<li class="treeview" id="menuPembelian">
		...
		<ul class="treeview-menu">
			{section name=dataAuthorize loop=$dataAuthorize}
				...
				{/if}
				{if $dataAuthorize[dataAuthorize].modulID == 30 AND strpos("{$dataAuthorize[dataAuthorize].authorize}", "{$loginStaffLevel}") !== false}
	...
	<li class="treeview" id="menuPenjualan">
		...
		<ul class="treeview-menu">
			{section name=dataAuthorize loop=$dataAuthorize}
				...
				{/if}
				{if $dataAuthorize[dataAuthorize].modulID == 31 AND strpos("{$dataAuthorize[dataAuthorize].authorize}", "{$loginStaffLevel}") !== false}
