			...
			<td>
				...
				<table cellpadding="3" cellspacing="3">
					<tr>
						...
						<td><input type="text" value="{$customerCode}" id="customerCode" name="customerCode" class="form-control" placeholder="Kode Customer" style="width: 270px;" required></td>
						<td colspan="4"></td>
					</tr>
					<tr>
					...
					<tr>
						<td width="150" style="font-size: 14px; border-left: 1px solid #000000; background-color: #FFFFFF;">Nama Customer</td>
						<td style="font-size: 14px; background-color: #FFFFFF;">:</td>
						<td style="font-size: 14px; border-right: 1px solid #000000; background-color: #FFFFFF;"><input type="text" value="{$customerName}" id="customerName" name="customerName" class="form-control" placeholder="Nama Customer" style="width: 270px;" required></td>
						<td width="50"></td>
					...
					<tr>
						...
						<td style="border-bottom: 1px solid #000000; border-right: 1px solid #000000; background-color: #FFFFFF;"><input type="email" id="email" value="{$email}" name="email" class="form-control" placeholder="Email" style="width: 270px;"></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="font-size: 14px; border-left: 1px solid #000000; background-color: #FFFFFF;">Telepon</td>
						<td style="font-size: 14px; background-color: #FFFFFF;">:</td>
						<td style="border-right: 1px solid #000000; background-color: #FFFFFF;"><input type="text" id="phone1" name="phone1" value="{$phone1}" class="form-control" placeholder="Telepon 1" style="width: 90px; float: left;">
							<input type="text" value="{$phone2}" id="phone2" name="phone2" class="form-control" placeholder="Telepon 2" style="width: 90px; float: left;">
							<input type="text" value="{$phone3}" id="phone3" name="phone3" class="form-control" placeholder="Telepon 3" style="width: 90px;"> 
						</td>
						<td></td>
						<td style="font-size: 14px; border-left: 1px solid #000000; background-color: #FFFFFF;">Nama PKP</td>
						<td style="font-size: 14px; background-color: #FFFFFF;">:</td>
					...
					<tr>
						<td style="font-size: 14px; border-left: 1px solid #000000; background-color: #FFFFFF;">Faksimile</td>
						<td style="font-size: 14px; background-color: #FFFFFF;">:</td>
						<td style="border-right: 1px solid #000000; background-color: #FFFFFF;"><input type="text" id="fax1" name="fax1" value="{$fax1}" class="form-control" placeholder="Fax 1" style="width: 90px; float: left;">
							<input type="text" id="fax2" value="{$fax2}" name="fax2" class="form-control" placeholder="Fax 2" style="width: 90px; float: left;">
							<input type="text" id="fax3" name="fax3" value="{$fax3}" class="form-control" placeholder="Fax 3" style="width: 90px;"> 
						</td>
						<td></td>
					...
					<tr valign="top">
						...
						<td style="font-size: 14px; background-color: #FFFFFF;">:</td>
						<td style="border-right: 1px solid #000000; background-color: #FFFFFF;"><input type="number" id="discount1" name="discount1" value="{$disc1}" class="form-control" placeholder="Diskon 1" style="width: 90px; float: left;">
