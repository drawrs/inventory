<?php /* Smarty version Smarty-3.1.11, created on 2017-11-11 00:45:27
         compiled from "./templates/side_menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13370682815a05c7e199e6f8-88554123%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '13370682815a05c7e199e6f8-88554123',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_5a05c7e1e03cc7_77642596',
  'variables' => 
  array (
    'dataAuthorize' => 0,
    'loginStaffLevel' => 0,
...
<?php if ($_valid && !is_callable('content_5a05c7e1e03cc7_77642596')) {function content_5a05c7e1e03cc7_77642596($_smarty_tpl) {?><!-- sidebar menu: : style can be found in sidebar.less -->
<ul class="sidebar-menu">
	...
	<li class="treeview" id="menuMasterData">
		<a href="#">
			<i class="fa fa-th"></i>
...
?>
	...
	<li class="treeview" id="menuPembelian">
		<a href="#">
			<i class="fa fa-laptop"></i>
...
?>
				...
				<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['dataAuthorize']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataAuthorize']['index']]['modulID']==30&&strpos(((string)$_smarty_tpl->tpl_vars['dataAuthorize']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataAuthorize']['index']]['authorize']),((string)$_smarty_tpl->tpl_vars['loginStaffLevel']->value))!==false){?>
				    <li><a href="pay_sps.php"><i class="fa fa-angle-double-right"></i> Pembayaran Transaksi Khusus</a></li>
				<?php }?>	
			<?php endfor; endif; ?>
		</ul>
	</li>
	<li class="treeview" id="menuPenjualan">
		<a href="#">
			<i class="fa fa-laptop"></i>
...
?>
		...
		<?php }?>
	<?php endfor; endif; ?>
	<li class="treeview" id="menuPengembalian">
		<a href="#">
...
?>
		...
		<?php }?>
	<?php endfor; endif; ?>
	<li class="treeview" id="menuLaporan">
		<a href="#">
...
?>
	...
	<li class="treeview" id="menuHutang">
		<a href="#">
