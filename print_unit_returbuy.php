...
if ($_SESSION['staffID'] == '' && $_SESSION['email'] == '')
{
	...
	if ($module == 'returbuy' && $act == 'print')
	{
		...
		$queryMain = "SELECT * FROM as_retur_suppliers WHERE returID = '$returID' AND returNo = '$returNo'";
		...
		$content = "<table style='padding-bottom: 10px; width: 240mm;'>
					...
					<table cellpadding='0' cellspacing='0' style='width: 240mm; border-bottom: 1px solid #000;'>
						...
						$queryReturDetail = "SELECT * FROM as_detail_retur_suppliers WHERE returNo = '$returNo' ORDER BY detailID ASC";
