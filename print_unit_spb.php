...
if ($_SESSION['staffID'] == '' && $_SESSION['email'] == '')
{
	...
	if ($module == 'spb' && $act == 'print')
	{
		...
		$queryMain = "SELECT * FROM as_spb WHERE spbID = '$spbID' AND spbFaktur = '$spbFaktur'";
		...
		$content = "<table style='padding-bottom: 10px; width: 240mm;'>
					...
					<table cellpadding='0' cellspacing='0' style='width: 240mm; border-bottom: 1px solid #000;'>
						...
						$queryTransferDetail = "SELECT * FROM as_detail_spb WHERE spbFaktur = '$spbFaktur' AND spbNo = '$dataMain[spbNo]' ORDER BY detailID ASC";
